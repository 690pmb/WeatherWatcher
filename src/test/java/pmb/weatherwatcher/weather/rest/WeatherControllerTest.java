...
class WeatherControllerTest {
  ...
  class FindForecastByLocation {
    ...
    void not_found() throws Exception {
      ...
      mockMvc
          .perform(get("/weathers").contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void not_content() throws Exception {
      ...
      mockMvc
          .perform(
              get("/weathers").param("days", "6").contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  class SearchLocations {
    ...
    void ok() throws Exception {
      ...
      SearchJsonResponse[] actual =
          objectMapper.readValue(
              TestUtils.readResponse.apply(
                  mockMvc
                      .perform(
                          get("/weathers/locations")
                              .param("query", "lyon")
                              .contentType(MediaType.APPLICATION_JSON_VALUE))
                      .andExpect(status().isOk())),
      ...
      assertAll(
          ...
          () -> assertThat(actual[0]).usingRecursiveComparison().isEqualTo(response));
    ...
    void missing_query() throws Exception {
      mockMvc
          .perform(get("/weathers/locations").contentType(MediaType.APPLICATION_JSON_VALUE))
